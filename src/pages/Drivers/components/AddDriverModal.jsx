          ...
          <form onSubmit={handleFormSubmit(onSubmit)}>
            <VStack
              ...
              <HStack
                ...
                <FormControl
                  isInvalid={!!errors.load_eligibility}
                  flex={1}>
                  <FormLabel className={styles.fieldLabel}>
              ...
              <HStack
                ...
                align="stretch">
                <FormControl
                  isInvalid={!!errors.emergency_first_name}
                  flex={1}>
                  <FormLabel className={styles.fieldLabel}>
                    First Name <span className={styles.required}>*</span>
                  </FormLabel>
                ...
                <FormControl
                  isInvalid={!!errors.emergency_last_name}
                  flex={1}>
                  <FormLabel className={styles.fieldLabel}>
                    Last Name <span className={styles.required}>*</span>
                  </FormLabel>
