        ...
        <InfoAccordionPanel>
          {/* <Box
            ...
            <CardData
              ...
              <StatusText title="DOT Date:" data={add_date || "N/A"} />
            </CardData>
              ...
              <Box display="flex" gap="8px">
                <Box flexGrow={1}>
                  <StatusText
                    ...
                    data={
                      responseStatuses(extraData?.authorized_for_hire).label
                    }
                  />
                  <StatusText
                  ...
                  <StatusText
                    ...
                    data={
                      responseStatuses(extraData?.private_passenger_business)
                        .label
                    }
                  />
                  <StatusText
                    ...
                    data={
                      responseStatuses(extraData?.private_passenger_nonbusiness)
                        .label
                    }
                  />
                  <StatusText
          ...
          <Box mt="40px">
            <CardData>
              ...
              <Box
                ...
                gap="20px">
                <Box display="flex" flexDirection="column" gap="8px">
                  <StatusText title="Total Drivers:" data={total_drivers} />
                  <StatusText title="CDL Employed Drivers:" data={total_cdl} />
                  <StatusText
          ...
          <Box mt="40px">
            <CardData>
              ...
              <Box
                ...
                gap="20px">
                <Box display="flex" flexDirection="column" gap="8px">
                  <StatusText title="Fleet Size:" data={fleetsize} />
                  <StatusText title="Total Power Units:" data={power_units} />
                  <StatusText title="Total Trucks:" data={truck_units} />
                </Box>
                <Box display="flex" flexDirection="column" gap="8px">
                  <StatusText title="Tractors Owned:" data={owntract} />
                  <StatusText title="Trucks Owned:" data={owntruck} />
                  <StatusText title="Trailers Owned:" data={owntrail} />
                </Box>
              </Box>
            </CardData>
          </Box> */}
